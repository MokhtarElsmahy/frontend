...
@Component({
  selector: 'app-libraries-exchange-archived',
  templateUrl: './libraries-exchange-archived.component.html',
  styleUrls: ['./libraries-exchange-archived.component.scss']
})
export class LibrariesExchangeArchivedComponent implements OnInit {
  userId: string
  ...
  constructor(public translate: TranslateService,
    ...
    public LibService: LibraryExchangeRequestService,
  ...
  archiveConfirmation(CopyRequestVM: LibraryExchangeRequestVM){
    this.openModal();
    ...
    this.confirmationModalService.confirmAction = this.LibService.UnArchivedAndUpdateGiftBookRequest;
  ...
  GetArchivedCopyRequests() {
    this.spinner.show();
    this.LibService.GetArchivedLibraryExchangeRequests(this.userId).then(
      (res) => {
